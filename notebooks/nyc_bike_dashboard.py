...
# Load data with caching - EXACT PATHS FROM NOTEBOOK
@st.cache_data
def load_dashboard_data():
    # These are the exact files created in your notebook
    top_stations = pd.read_csv('top_20_stations_full.csv')  # Created in cell 77
    daily_data = pd.read_csv('daily_aggregated_data_full.csv')  # Created in cell 66
